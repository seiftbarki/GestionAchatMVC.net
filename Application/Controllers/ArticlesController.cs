...
namespace Application.Controllers
{
    ...
    public class ArticlesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Designation,Quantite,prix,taxe")] Article article)
        {
            if (ModelState.IsValid)
            {
                //article.Decision = "Waiting";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Designation,Quantite,prix,taxe,Decision")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
